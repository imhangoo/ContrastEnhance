...
int main()
{
    for (int i = 0; i < 6; i++)
    {
        ...
        if (i == 0)
        {
            ...
            printf("Round 0 is only used to initialize, should not be counted. Chekc result from round 1.\n");
        }
...
void run_gpu_color_test(PPM_IMG img_in)
{
    ...
    write_ppm(img_obuf_hsl, "out_hsl2.ppm");
    ...
    write_ppm(img_obuf_yuv, "out_yuv2.ppm");
